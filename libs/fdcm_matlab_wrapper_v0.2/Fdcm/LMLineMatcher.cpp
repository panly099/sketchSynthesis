...
{	
	...
	{			
		...
		double dbWidth = (double)(queryImage_.width_-(int)(maxx-minx) )/searchStepSize_;
		double dbHeight = (double)(queryImage_.height_-(int)(maxy-miny) )/searchStepSize_;
        width = ceil(dbWidth);
		height = ceil(dbHeight);
